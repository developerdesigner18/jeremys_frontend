...
import { getUserWithId, hideTheStory, getReviewOfFan, getReviewOfArtist, hideReview } from "../../actions/userActions";
...
function MyStory(props) {
    ...
    const [journalDataTemp, setJournalData] = useState([{ time: "121212", items: "asasasasa", orderTotal: "121", tips: "11", total: "123" }, { time: "121212", items: "asasasasa", orderTotal: "121", tips: "11", total: "123" }, { time: "121212", items: "asasasasa", orderTotal: "121", tips: "11", total: "123" }, { time: "121212", items: "asasasasa", orderTotal: "121", tips: "11", total: "123" }, { time: "121212", items: "asasasasa", orderTotal: "121", tips: "11", total: "123" }, { time: "121212", items: "asasasasa", orderTotal: "121", tips: "11", total: "123" }]);
    ...
    useEffect(() => {
        if (stateData) {
            ...
            if (stateData.userInfo) {
                ...
                var publicStory = stateData.userInfo.data.screenShots.filter(element => element.private == "0")
                ...
                if (stateData.userInfo.data.type === "Fan") {
                    if (stateData.reviewOfFan) {
                        ...
                        if (props.location.state.isMystory) {
                            ...
                            var publicFanReview = stateData.reviewOfFan.filter(element => element.hideByFan === false)
                    ...
                    if (stateData.reviewOfArtist) {
                        ...
                        if (props.location.state.isMystory) {
                            ...
                            var publicArtistReview = stateData.reviewOfArtist.filter(element => element.hideByArtist === false)
                    ...
                    <div className="chef_container d-flex">
                        <div className="position-relative chef_image_sec">
                            ...
                            <div className="down_chef_links position-absolute">
                                ...
                                <div className="mystory_option" onClick={() => setRightPart(3)} style={{ fontWeight: rightPart === 3 ? "600" : "" }}>Journals</div>
                            </div>
                            <div className="bottom_action position-absolute d-flex">
                                <div className="heart_image">
                                    <img src="../assets/images/heart.png" />
                                </div>
                                {userInfo ? userInfo.data.type !== "Fan" ? <div className="followers">FOLLOWERS: {followers}</div> : <div className="followers">FOLLOWING: {following}</div> : ""
                                }
                            </div>
                        </div>
                        {
                            rightPart === 1 ?
                                <>
                                    <div className="journal_sec position-relative" style={{ alignItems: "center" }}>
                                        {
                                                        ...
                                                        <div>
                                                            ...
                                                            {isMyStory ?
                                                                <div className="storysub2">
                                                                    {
                                                                        <input type="checkbox" checked={screenShot[screenShotCounter].private == "0" ? false : true}
                                                                            onChange={() => {
                                                                                StoryPrivate(screenShot[screenShotCounter].private, screenShot[screenShotCounter]._id)
                                                                            }}
                                                                        />
                                                                    }
                                                                    <p>Hide this Page</p>
                                                        ...
                                                        <table className="tableJournal">
                                                            {console.log("revieewew name", reviewDataName)}
                                                            {
                                                                currentreview.map(((element, index) => {
                                                                    return <tr className="fanReviewTable">
                                                                        {
                                                                            userInfo ? userInfo.data.type === "Fan" ?
                                                                                <>
                                                                                    <td><img src={element.artistId.profileImgURl} className="fanReviewTable_image"></img></td>
                                                                                    <td>
                                                                                        <p className="fanReviewTable_time">{element.date}</p>
                                                                                        <div className="fanReviewTable_time_name">
                                                                                            <p>{element.artistId.firstName}</p>
                                                                                            <p style={{ textTransform: "uppercase", fontWeight: "600" }}>{element.artistId.type}</p>
                                                                                        </div>
                                                                                        <p className="fanReviewTable_comment">{element.review}</p>
                                                                                        {isMyStory ?
                                                                                                <div className="fanReviewTable_hide">
                                                                                                    <input type="checkbox" checked={element.hideByFan}
                                                                                                        onChange={() => {
                                                                                                            reviewPrivate("Fan", element._id, element.hideByFan, index)
                                                                                                        }}></input>
                                                                                ...
                                                                                :
                                                                                <>
                                                                                    <td><img src={element.fanId.profileImgURl} className="fanReviewTable_image"></img></td>
                                                                                    <td>
                                                                                        <p className="fanReviewTable_time">{element.date}</p>
                                                                                        <div className="fanReviewTable_time_name">
                                                                                            <p>{element.fanId.firstName}</p>
                                                                                            <p style={{ textTransform: "uppercase", fontWeight: "600" }}>{element.fanId.type}</p>
                                                                                        </div>
                                                                                        <p className="fanReviewTable_comment">{element.review}</p>
                                                                                        {isMyStory ?
                                                                                                <div className="fanReviewTable_hide">
                                                                                                    <input type="checkbox" checked={element.hideByArtist}
                                                                                                        onChange={() => {
                                                                                                            reviewPrivate("Artist", element._id, element.hideByArtist, index)
                                                                                                        }}></input>
                                                                                                    <label>Hide this page</label>
                                                                                                </div> : ""
                                                                                        }
                                                                        ...
                                                                        <td style={{ textTransform: "uppercase", fontWeight: "600" }}>{element.item}</td>
                                                                        <td>
                                                                            <StarRatings
                                    ...
                                    <>
                                        <div className="journal_sec position-relative">
                                            <div className="mainDivJournal">
                                                ...
                                                <table className="tableJournal">
                                                    {
                                                        userInfo ? (userInfo.data.type == "Star" || userInfo.data.type == "Trainer") ?
                                                            <>
                                                                <tr>
                                                                    <th></th>
                                                                    <th>DURATION</th>
                                                                    <th>TICKET <br></br> SOLD</th>
                                                                    <th>TICKET <br></br> PRICE</th>
                                                                    <th>TIPS</th>
                                                                    <th>TOTAL <br></br> EARNINGS</th>
                                                                </tr>
                                                                {current.map((element) => {
                                                                    return <tr>
                                                                        <td>{element.time}</td>
                                                            ...
                                                            :
                                                            (userInfo.data.type == "Chef" || userInfo.data.type == "Stylist") ?
                                                                <>
                                                                    <tr>
                                                                        <th></th>
                                                                        <th>ITEMS</th>
                                                                ...
                                                                <>
                                                                    {current.map((element) => {
                                                                        return <tr className="fanJurnalTable">
                                                                            <td><img src={"../assets/images/star.jpg"}></img></td>
                                                                            <td>
                                                                                <p>{element.time}</p>
                                                                                <div className="fanJurnalMain">
                                                                                    <p>stylist</p>
                                                                                    <p style={{ textTransform: "uppercase", fontWeight: "600" }}>FAN</p>
                                                                                </div>
                                                                            </td>
                                                                            <td style={{ textTransform: "uppercase", fontWeight: "600" }}>Title</td>
                                                                            <td><p>payment methods</p>account Number<p></p></td>
                                                                        </tr>
                                                                    })
                                                                    }
                                                                </>
