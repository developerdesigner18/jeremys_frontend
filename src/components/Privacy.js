  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Jeremy's Live unless
      ...
      <p>
        ...
        but not limited to First name, Last name, Email address, Phone number.
      ...
      <p>This policy is effective as of 2021-04-14</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at admin@jeremyslive.com.
      </p>{" "}
      <p>
